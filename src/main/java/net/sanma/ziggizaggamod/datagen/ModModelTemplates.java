...
public class ModModelTemplates extends ModelTemplates {
    ...
    public static final ModModelTemplate SCALED_HANDHELD_ITEM = createItem("handheld",TextureSlot.LAYER0);
    public static ModModelTemplate create(String pName, String pSuffix, TextureSlot... pRequiredSlots) {
    ...
    public static ModModelTemplate createItem(String p_378751_, TextureSlot... p_377825_) {
        return new ModModelTemplate(Optional.of(ResourceLocation.withDefaultNamespace("item/" + p_378751_)), Optional.empty(), p_377825_);
    }
}